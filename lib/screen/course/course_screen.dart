...
class CoursesScreen extends StatelessWidget {
  static const routName = '/corse-screen';
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        // drawer: AppDrawer(),
        body: FutureBuilder(
            future: Provider.of<Courses>(context, listen: false).fetchCourses(1
                ...
                return Consumer<Courses>(
                    builder: (ctx, courseData, _) => ListView.builder(
                        ...
                        itemBuilder: (ctx, index) =>
                            ...
                            //                   border: Border.all()),
                            //               child: Text(
                            //                 courseData.courses[index].courseName!,
